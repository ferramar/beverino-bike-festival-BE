...
export interface ApiMediaEdizioniMediaEdizioni
  ...
  info: {
    displayName: 'Media edizioni';
    pluralName: 'media-edizionis';
    singularName: 'media-edizioni';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    edizione: Schema.Attribute.Integer & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::media-edizioni.media-edizioni'
    > &
      Schema.Attribute.Private;
